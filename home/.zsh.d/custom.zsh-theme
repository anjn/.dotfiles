...
PROMPT_PREFIX=$(str_with_color black '#')
SEPARATOR1=$(str_with_color black '|')
USER_NAME=$(str_with_color blue '%n')
SEPARATOR2=$(str_with_color black '@')
HOST_NAME=$(str_with_color cyan '%m')
SEPARATOR3=$(str_with_color black ':')
CURRENT_DIRECTORY=$(str_with_color green '%~')
PROMPT_CHAR=$(str_with_color black '$ ')
PROMPT='${USER_NAME}${SEPARATOR2}${HOST_NAME}${SEPARATOR3}${CURRENT_DIRECTORY} $(my_git_status)
$PROMPT_CHAR'
PROMPT2=$(str_with_color black '> ')
